...
import bot.seven.WLR.bot.features.*
...
class OP : BotBase("/play duels_op_duel"), Bow, Rod, MovePriority, Potion, Gap {
    ...
    override fun onTick() {
        ...
        if (opponent != null && mc.theWorld != null && mc.thePlayer != null) {
            ...
            if (distance > 8.8) {
                if (opponent.heldItem != null && opponent.heldItem.unlocalizedName.lowercase().contains("bow")) {
                    ...
                    if (opponent.isInvisibleToPlayer(mc.thePlayer)) {
                        ...
                        if (EntityUtils.entityFacingAway(mc.thePlayer, opponent)) {
                            ...
                            if (distance in 15f..8f) {
                                ...
                                randomStrafe = false
                                if (opponent.heldItem != null && (opponent.heldItem.unlocalizedName.lowercase().contains("bow") || opponent.heldItem.unlocalizedName.lowercase().contains("rod"))) {
                                    randomStrafe = true
                                    if (distance < 15) {
                                        Movement.stopJumping()
                                    }
